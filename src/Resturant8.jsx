...
const Resturant8 = () => {
  const [resturant8, setResturant8] = useState([]);
  const {
    name,
    cart,
    setCart,
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        "https://resturant-be.onrender.com/api/hotel8/getAllFoods"
      );
      setResturant8(res.data.foods);
    } catch (error) {
