...
const Resturant4 = () => {
  const [resturant4, setResturant4] = useState([]);
  const {
    name,
    cart,
    setCart,
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        "https://resturant-be.onrender.com/api/hotel4/getAllFoods"
      );
      setResturant4(res.data.foods);
    } catch (error) {
