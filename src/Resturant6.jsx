...
const Resturant6 = () => {
  const [resturant6, setResturant6] = useState([]);
  const {
    name,
    cart,
    setCart,
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        "https://resturant-be.onrender.com/api/hotel6/getAllFoods"
      );
      setResturant6(res.data.foods);
    } catch (error) {
