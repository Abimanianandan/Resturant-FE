...
const Resturant1 = () => {
  const [resturant1, setResturant1] = useState([]);
  const {
    name,
    cart,
    setCart,
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        "https://resturant-be.onrender.com/api/hotel1/getAllFoods"
      );
      setResturant1(res.data.foods);
    } catch (error) {
