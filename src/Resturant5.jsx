...
const Resturant5 = () => {
  const [resturant5, setResturant5] = useState([]);
  const {
    name,
    cart,
    setCart,
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        "https://resturant-be.onrender.com/api/hotel5/getAllFoods"
      );
      setResturant5(res.data.foods);
    } catch (error) {
